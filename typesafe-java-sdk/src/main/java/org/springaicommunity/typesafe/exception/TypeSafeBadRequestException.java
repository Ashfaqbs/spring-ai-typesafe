...
/**
 * Raised on HTTP 400. The request was invalid.
 *
 * @author Christian Tzolov
 */
public class TypeSafeBadRequestException extends TypeSafeApiException {

	public TypeSafeBadRequestException(String message, int status, @Nullable String body, HttpHeaders headers, String endpoint) {
